    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://avatars.githubusercontent.com/u/30386026"
              alt="viswa2k portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        ...
        building <span className="italic">sites & apps</span>. I love to automate everything with{" "}
      ...
      >
        ...
        <a
          ...
          href="https://linkedin.com/in/viswanathanTJ"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/viswanathanTJ"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
